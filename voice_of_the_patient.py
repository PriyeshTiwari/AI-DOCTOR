...
# #ffmpeg and portaudio are required for audio recording
# #install ffmpeg and portaudio using pip
...
# #step2: Setup Speech to text-STT-model for trancription
# import os
...
#         # Use the Groq client to transcribe the audio file
#         # The transcription will be in English by default
