...
#     print("DEBUG: audio_filepath =", audio_filepath)
#     print("DEBUG: image_filepath =", image_filepath)
    
#     if audio_filepath is None:
#         return "No audio recorded", "No image analyzed", None
...
#     )
#     # baaki code jaisa hai waise hi rakho ...
...
#         model="meta-llama/llama-4-scout-17b-16e-instruct") #model="meta-llama/llama-4-maverick-17b-128e-instruct") 
#     else:
...
#         gr.Textbox(label="Doctors's Response"),
